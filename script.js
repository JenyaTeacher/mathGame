...
class Player {
    constructor() {
        this.width = 150; this.height = 340;
...
class Teacher {
    constructor() {
        this.width = 120; this.height = 185;
...
class Marker {
    constructor(x, y, angle) {
        ...
        this.speed = 7; this.w = 12; this.h = 50;
    }
 draw() {
        ctx.save(); 
...
function animate(time) {
    ...
    if (Math.hypot(player.x - teacher.x, player.y - teacher.y) < (player.width/2 + teacher.width/2) - 15) endGame();
}
